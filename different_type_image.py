...
img_path_raw = './logs/20210923-080129_base_YOLO_with_coco_datasets2/73.6_asr.raw'
img_tensor = raw2torch(img_path_raw, np.array([3, 950, 950]))
adv = img_tensor.cuda()
torchvision.utils.save_image(adv, './paper_images/save_as_png.png')
torchvision.utils.save_image(adv, './paper_images/save_as_jpg.jpg')
